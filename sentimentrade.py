...
def display_fig2(selected_ticker):
    ...
    data_table_with_signals['Open'] = data_table_with_signals['Open'].apply(lambda x: '{:.2f}'.format(x) if pd.notnull(x) else '')
    data_table_with_signals['High'] = data_table_with_signals['High'].apply(lambda x: '{:.2f}'.format(x) if pd.notnull(x) else '')
    data_table_with_signals['Low'] = data_table_with_signals['Low'].apply(lambda x: '{:.2f}'.format(x) if pd.notnull(x) else '')
    data_table_with_signals['Close'] = data_table_with_signals['Close'].apply(lambda x: '{:.2f}'.format(x) if pd.notnull(x) else '')
    data_table_with_signals['Adj Close'] = data_table_with_signals['Adj Close'].apply(lambda x: '{:.2f}'.format(x) if pd.notnull(x) else '')
    data_table_with_signals['10_MA'] = data_table_with_signals['10_MA'].apply(lambda x: '{:.2f}'.format(x) if pd.notnull(x) else '')
    data_table_with_signals['20_MA'] = data_table_with_signals['20_MA'].apply(lambda x: '{:.2f}'.format(x) if pd.notnull(x) else '')
